...
import vn.iotstar.bt09b.dto.*;
import vn.iotstar.bt09b.service.AuthService;
...
public class AuthController {
    ...
    public String reset(@Valid @ModelAttribute ResetPasswordDTO dto, BindingResult result, @RequestParam String otp, RedirectAttributes redirect) {
